...
--dofile("jitlog/test.lua")
local format = string.format

local path = [[C:\work\lua_benchmarking\jitlog.bin]]
...
for i=1, 10 do
  logs[i] = parselog(format([[C:\work\lua_benchmarking\log%d.bin]], i))
end

function processmarkers(reader)
