...
context("__mcode", function()
  ...
  it("cmpxchg", function()
    assert_cdef([[void cmpxchg(int32_t* gpr32, int32_t gpr32, int32_t eax) __mcode("0FB1mRPEIS", 0xF0) __reglist(out, int32_t eax);]], "cmpxchg")
...
if ffi.arch == "x64" then  
  it("cmpxchg64", function()
    assert_cdef([[void cmpxchg64(int64_t* gpr64, int64_t gpr64, int64_t rax) __mcode("0FB1mRPEISX", 0xF0) __reglist(out, int64_t rax);]], "cmpxchg64")
  ...
  it("cmpxchg8b", function()
    ...
    assert_cdef([[void cmpxchg8b(void* gpr32, int32_t eax, int32_t edx, int32_t ebx, int32_t ecx) __mcode("0FC71mPEIS", 0xf0) 
...
it("vpslldq(avx)", function()
  ...
  local vout = ffi.C.vpslldq_4(v)

  assert_equal(vout[0], 0)
  assert_equal(vout[1], 1)
  assert_equal(vout[2], 2)
  assert_equal(vout[3], 3)
end)
